...
df= pd.read_excel("P&L final.xlsm",sheet_name='data', skiprows=5,nrows=18, usecols="D:Q")
...
dropdowns=     html.Div([dcc.Dropdown (id= 'month_picker', 
                    ...
                    # style = {'width': '175px',  'align-items': 'center', 'justify-content': 'center'}
                            
                            )])
wfgraph = html.Div([dbc.Card(
    [
...
donut_card = html.Div([
  ...
  html.Div(html.A(html.P("Net Profit Margin %"), style={'text-align': 'center', "font-weight": "bold"})),
                    html.A(dcc.Graph(config={'displayModeBar':False},id="dnc"), style={'text-align': 'center', "font-weight": "bold"})
                ]),
            ]
        ),
...
#             [
#                 dbc.Row([
#                 dbc.Col(dbc.Card(donut_card, style={'height':'100%'}), width='100%'),
#                         ]),
#                 dbc.Row([
#                 dbc.Col(dbc.Card(incpie, style={'height':'100%'}), width='100%'),
#                         ]),
#                 dbc.Row([
#                 dbc.Col(dbc.Card(expie, style={'height':'100%'}), width='100%' ),
#                         ]),
#             ])
...
#     dbc.Row(
#     [
#         dbc.Col(dbc.Card(wfgraph, style={'height':'100%'}), width='100%'),
#         dbc.Col(dbc.Card(donut_card, style={'height':'100%'}), width='100%'),
#         dbc.Col(dbc.Card(dashbar, style={'height':'100%'}),  width='100%'),
...
#     dbc.Row(
#             [
#                 dbc.Col(dbc.Card(incomecard, style={'height':'100%'}),width= '100%'),
#                 dbc.Col(dbc.Card(expensescard, style={'height':'100%'}),width='100%' ),
#                 dbc.Col(dbc.Card(incpie, style={'height':'100%'}), width='100%'),
#                 dbc.Col(dbc.Card(accountsrecieveable, style={'height':'100%'}),width='100%' ),
#                 dbc.Col(dbc.Card(accountspayable, style={'height':'100%'}),width='100%' ),
                
#             ]),

#     dbc.Row(
#             [
#                 dbc.Col(dbc.Card(netprofitcard, style={'height':'100%'}),width= '100%' ),
#                 dbc.Col(dbc.Card(cashatEOM, style={'height':'100%'}),width= '100%' ),
#                 dbc.Col(dbc.Card(expie, style={'height':'100%'}), width='100%' ),
#                 dbc.Col(dbc.Card(quickratio, style={'height':'100%'}), width= '100%'),
#                 dbc.Col(dbc.Card(currentratio, style={'height':'100%'}), width= '100%'),
...
#     dbc.Row(
#     [
#         dbc.Col(dbc.Card(dashbar, style={'height':'100%'}),  width='auto'),
#     ]),
...
#             [
#                 dbc.Col(dbc.Card(accountsrecieveable, style={'height':'100%'}),width='auto' ),
#                 dbc.Col(dbc.Card(accountspayable, style={'height':'100%'}),width='auto' ),
                
                
#             ]), 
#     dbc.Row(
#             [
#             dbc.Col(dbc.Card(quickratio, style={'height':'100%'}), ),
#             dbc.Col(dbc.Card(currentratio, style={'height':'100%'}), ),
#             ]),
...
lineone=html.Div([ 
    ...
    dbc.Row(
            [
                dbc.Col(dbc.Card(incomecard, style={'height':'100%', 'margin-left':'135px'}),width= '100%'),
                dbc.Col(dbc.Card(expensescard, style={'height':'100%'}),width='100%' ),
                dbc.Col(dbc.Card(incpie, style={'height':'100%'}), width='100%'),
                dbc.Col(dbc.Card(accountsrecieveable, style={'height':'100%'}),width='100%' ),
                dbc.Col(dbc.Card(accountspayable, style={'height':'100%'}),width='100%' ),
    ...
    dbc.Row(
            [
                dbc.Col(dbc.Card(netprofitcard, style={'height':'100%', 'margin-left':'135px'}),width= '100%' ),
                dbc.Col(dbc.Card(cashatEOM, style={'height':'100%'}),width= '100%' ),
                dbc.Col(dbc.Card(expie, style={'height':'100%'}), width='100%' ),
                dbc.Col(dbc.Card(quickratio, style={'height':'100%'}), width= '100%'),
                dbc.Col(dbc.Card(currentratio, style={'height':'100%'}), width= '100%'),
...
cards = html.Div(
    [
        dbc.Row(
            [
                dbc.Col(dbc.Card( dropdowns, style={'height':'100%', 'margin-left':'50px'}), width='175px'),
                ...
                # dbc.Col(dbc.Card(linetwo, style={'height':'100%'}), width='auto'),
                #   dbc.Col(dbc.Card(pie_cards, style={'height':'100%'}),width='100%' ),
            ]),
           ])
...
#     go.Bar(name='LA Zoo', x=db[1:]["cat"], y=db[1:]["Income"]-db[1:]["Operating Profit (EBIT)"]),
#     go.Bar(name='SF Zoo', x=db[1:]["cat"], y=db[1:]["Operating Profit (EBIT)"]),

# ]).update_layout(barmode='stack').update_layout(
#     showlegend=False,
#     plot_bgcolor="white",
#     height=300,
#     width=450,
